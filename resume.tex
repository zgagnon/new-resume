...
\begin{center}
	...
	\\
	\vspace{2mm}
	{\fontsize{1em}{1em}\fontspec[Path = fonts/]{Montserrat-Light} zoe@zgagnon.com -- 7203014407 -- Troy NY -- zgagnon.com}
\end{center}
...
\job
	...
	\item {Managed 10+ engineers, from intern to staff+ level. Guided growth into team leadership and management positions}
	\item {Led diverse strategic and tactical efforts including the demo product for Google Next, the Unified Experience product, and
	the release engineering function}
	\item {Enhanced organizational capability with cross-platform retros, strategy sesssions, management development, and internship programs}
	\end{newitemize}
		}
\job
	{Mechanical Orchard}
	...
	{
	\begin{newitemize}
	\item {Consultant on Mainframe Modernization project with Fortune 500 retailer}
	\item {Mentored junior engineers in deeply technical projects as well as Extreme Programming methodology}
	\end{newitemize}
		}

	\job
	{Orgspace}
	{Oct 2021 – November 2023}
	{Principle Engineer}
	{Beacon NY/Remote}
	{
	\begin{newitemize}
	...
	{
	\begin{newitemize}
		\item {	First engineering manager in the company, with a team of eight engineers. Established all processes for leveling, coaching, and performance management.}
