...
\job
	...
	{
	\begin{newitemize}
	\item {Manage 10+ engineers, from interns to Staff+ level. Guided growth into team leadership and management positions}
	\item {Lead diverse strategic and tactical efforts including the demo product for Google Next, the Unified Experience product, and
